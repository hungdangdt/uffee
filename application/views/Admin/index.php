                            ...
                            <div class="row">
                                <div class="col-12 text-center text-white">
                                    <div class="lorem_background">
                                        <div>
                                            <img src="public/admin/img/mailbox_imgs/2.jpg" alt="lorem" class="img-fluid rounded-circle lorem_img">
                                        </div>
                                    ...
                                    <div class="weather_img">
                                        <div class="row header_align">
                                            ...
                                            <div class="icon col-5 col-sm-4">
                                                <img src="public/admin/img/weather1.png" alt="weather" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                    ...
                                                    <div class="row header_align">
                                                        <div class="col-2 border_right days_margin_top">
                                                            <div class="day text-center">
                                                                ...
                                                                <div>
                                                                    <img src="public/admin/img/w5.png" alt="weather" class="img-fluid">
                                                                </div>
                                                        ...
                                                        <div class="col-2 border_right days_margin_top">
                                                            <div class="day text-center">
                                                                ...
                                                                <div>
                                                                    <img src="public/admin/img/w2.png" alt="weather" class="img-fluid">
                                                                </div>
                                                        ...
                                                        <div class="col-2 border_right days_margin_top">
                                                            <div class="day text-center">
                                                                ...
                                                                <div>
                                                                    <img src="public/admin/img/w3.png" alt="weather" class="img-fluid">
                                                                </div>
                                                        ...
                                                        <div class="col-2 border_right days_margin_top">
                                                            <div class="day text-center">
                                                                ...
                                                                <div>
                                                                    <img src="public/admin/img/w4.png" alt="weather" class="img-fluid">
                                                                </div>
