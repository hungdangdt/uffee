...
<head>
    ...
    <link rel="shortcut icon" href="/public/img/logo1.ico"/>
    <!--Global styles -->
    ...
    <!--Plugin styles-->
    <link type="text/css" rel="stylesheet" href="/public/vendors/bootstrapvalidator/css/bootstrapValidator.min.css"/>
    <link type="text/css" rel="stylesheet" href="/public/vendors/wow/css/animate.css"/>
    <link type="text/css" rel="stylesheet" href="/public/css/pages/login1.css"/>
</head>
<body>
...
z-index: 999999">
        <img src="/public/img/loader.gif" style=" width: 40px;" alt="loading...">
    </div>
</div>
                ...
                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-center">
                            <img src="/public/img/logow2.png" alt="josh logo" class="admire_logo"><span class="text-white"> ADMIRE &nbsp;<br/>
                                Log In</span>
                        </h3>
                    </div>
...
<script type="text/javascript" src="/public/vendors/wow/js/wow.min.js"></script>
<script type="text/javascript" src="/public/js/pages/login1.js"></script>
</body>
